...
int main()
{
  ...
  std::cout << "\nThe floating point is losing more precicion than the double." << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nfloating ponit precicion stays the same while double keeps losing precicion it goes to zero." << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nfloating point loses precicion while the double inputs an error." << std::endl;
